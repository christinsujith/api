...
class QueryType {
    ...
    public static $SORT_BY = "sortBy";     //orderBy
}
...
class StandardQueryParameters {
    ...
    public function __construct($format = null, $fields = null, $startIndex = null, $count = null, $networkDistance = null, $indexBy = null, $sortBy = null) {
        $this->format = $format;
        $this->fields = $fields;
